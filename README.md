...
1. Run the Product Key Generator Admin.py script (for admins) to generate a key.
2. Launch the app and enter the generated key when prompted.
Usage
Run the main application:
python main.py

1. Activation: Enter your Product Key on the first run.
2. Dashboard: Use the search bar to enter a stock ticker (e.g., AAPL, NVDA, TSLA).
3. Analysis View:
o View the interactive chart on the right.
o Read technical stats on the left.
o Click "Generate Analyst Insight" to get an AI-written report.
o Use the "Ask Artemis AI" button to chat with the assistant.
Project Structure
